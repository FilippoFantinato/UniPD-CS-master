...
public final class ATM_A_7 extends org.scribble.runtime.statechans.ReceiveSocket<ATM, A> implements Receive_A_C_Res_Boolean<ATM_A_2> {
	public static final ATM_A_7 cast = null;

	protected ATM_A_7(org.scribble.runtime.session.SessionEndpoint<ATM, A> se, boolean dummy) {
		super(se);
	}
	...
	public ATM_A_2 async(C role, Res op, org.scribble.runtime.util.Buf<ATM_A_7_Future> arg) throws org.scribble.main.ScribRuntimeException {
		arg.val = new ATM_A_7_Future(super.getFuture(ATM.C));
		return new ATM_A_2(this.se, true);
	}
	...
	public ATM_A_2 async(C role, Res op) throws org.scribble.main.ScribRuntimeException {
		return async(ATM.C, op, (org.scribble.runtime.util.Buf<ATM_A_7_Future>) this.se.gc);
	}
}